...
The demo app is built using **Kotlin** and utilizes the latest **YubiKit for Android**. It serves as a reference
implementation for:
...
- **Android Studio**.
- **Physical YubiKey** with 5.8.0+ firmware.
...
│   ├── arkg
│   │   ├── ARKGTrackView.kt
│   │   ├── ARKGTrackViewModel.kt
│   ├── signing
│   │   ├── SigningTrackView.kt
│   │   ├── SigningTrackViewModel.kt
├── app/src/main/java/com/yubico/eap/quickstart/math
│   ├── Arkg.kt # Cryptography abstraction using bouncy castle (here be dragons)
```
